...
class BrowsingPhotosViewController: UIViewController {
    ...
    func swipeLeftAction() {
        ...
        UIView.animateKeyframes(withDuration: 1, delay: 0, options: []) { UIView.addKeyframe(withRelativeStartTime: 0, relativeDuration: 0.3) {
    ...
    func swipeRightAction() {
        ...
        UIView.animateKeyframes(withDuration: 1, delay: 0, options: []) { UIView.addKeyframe(withRelativeStartTime: 0, relativeDuration: 0.7) {
